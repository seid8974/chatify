...
import { Loader, MessageCircle, Mail, Lock } from 'lucide-react'
              ...
              <div className='w-full max-w-md'>
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                  ...
                  <button className='auth-btn' type='submit' disabled={isLoggingIn}>
                    {isLoggingIn ? (<Loader className='w-full h-5 animate-spin text-center ' />) : ("Sign In")}
                  </button>
                </form>
                <div className='mt-6 text-center'>
                  <Link to="/signup" className='auth-link'>Don't you have an account? Sign Up</Link>
                </div>
              </div>
            </div>
